...
class EnrollmentTest(ModuleStoreTestCase):
    ...
    # TODO: We need separate test cases for both conditions in the auto-registration
    ...
    @ddt.data(
        ...
        (['honor', 'verified', 'audit'], 'course_modes_choose_autoreg', 'honor', True),
        ...
        (['professional'], 'course_modes_choose_autoreg', None, True),
    ...
    def _change_enrollment(self, action, course_id=None, auto_reg=False):
        ...
        Keyword Args:
            ...
            auto_reg (boolean): Whether to use the auto-registration hook.
                TODO: remove this once we complete the AB test for auto-registration.
